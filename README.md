...
## Como funciona
1. **Homepage → perguntas → chat**: chega na home, escolhe o caminho (papo com o coach ou o questionário de 8 perguntas). Quando o plano fecha, **o app abre direto no chat** com tudo liberado — e o coach já te entrega a lista de treinos com **links pro YouTube** (busca pronta): objetivo · onde treina (quarto/casa/parque/academia) · experiência · dias por semana · tempo por sessão · limitações físicas · rotina · nomes
